...
static void init(void) {
    img_background = load_bitmap_resized("./Assets/main-bg.jpg", SCREEN_W, SCREEN_H);
    // [HACKATHON 3-4]
    // TODO: Load settings images.
    // Uncomment and fill in the code below.
    img_settings = al_load_bitmap("./Assets/settings.png");
    img_settings2 = al_load_bitmap("./Assets/settings2.png");
